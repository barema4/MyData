        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>3 years of professional software engineering experience growing and developing distributed systems,
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience building APIs and Single-Page Applications using JavaScript,React, VueJs, Redux, Nodejs/express, Python, HTML,CSS</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
